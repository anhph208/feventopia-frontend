          ...
          <div className="row">
            ...
            <div className="col-lg-3 col-md-6">
              <div className="footer-content">
                ...
                <ul className="footer-link-list">
                  ...
                  <li>
                    <a href="/Term_and_condition" className="footer-link"  >
                      Điều khoản &amp; Dịch vụ
                    </a>
                  </li>
                </ul>
            ...
            <div className="col-lg-3 col-md-6">
              <div className="footer-content">
                ...
                <ul className="footer-link-list">
                  <li>
                    <a href="https://www.google.com/maps/place/Tr%C6%B0%E1%BB%9Dng+%C4%90%E1%BA%A1i+h%E1%BB%8Dc+FPT+TP.+HCM/@10.8411276,106.8073081,17z/data=!3m1!4b1!4m6!3m5!1s0x31752731176b07b1:0xb752b24b379bae5e!8m2!3d10.8411276!4d106.809883!16s%2Fg%2F11j2zx_fz_?hl=vi-VN&entry=ttu"
